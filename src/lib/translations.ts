...
type Translations = Record<TranslationKey, string | Record<string, string>>;
...
/**
 * Helper to get translation from request
 */
export function getTranslation(req: any): (key: string, params?: Record<string, string>) => string {
